...
const router = createBrowserRouter(
    createRoutesFromElements(
     <>
      <Route path="/" element={<PublicRoute><RootElement /></PublicRoute>}>
        <Route path=":chanelType" element={<ChanelPage />} ></Route>
        <Route path=":chanelType/checkout" element={<PrivateRoute><CheckoutPage /></PrivateRoute>}/>
        <Route path=":chanelType/thankyou" element={<PrivateRoute><ThankyouPage /></PrivateRoute>}/>
      </Route>
